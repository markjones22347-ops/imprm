...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    it_anim->second.label_anim = ImLerp(it_anim->second.label_anim, *v ? 0.5f : 0.0f, 0.07f * (1.0f - ImGui::GetIO().DeltaTime));
    it_anim->second.rect_anim = ImLerp(it_anim->second.rect_anim, *v ? 1.0f : (hovered ? 0.15f : 0.0f), 0.09f * (1.0f - ImGui::GetIO().DeltaTime));
    ...
    RenderFrame(check_bb.Min + ImVec2(pad, pad), check_bb.Max - ImVec2(pad, pad), ImColor(accent_colour[0], accent_colour[1], accent_colour[2], it_anim->second.rect_anim), false, 2.0f);
    ...
    if (label_size.x > 0.0f) {
        PushStyleColor(ImGuiCol_Text, ImVec4(1.f, 1.f, 1.f, content_animation * 0.5f + it_anim->second.label_anim));
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    const ImRect bb(window->DC.CursorPos + ImVec2(0, 15), window->DC.CursorPos + ImVec2(w, label_size.y + style.FramePadding.y * 2.0f + 15));
    const ImRect total_bb(bb.Min, bb.Max + ImVec2(0, 15));
    ItemSize(total_bb, style.FramePadding.y);
    ...
    {
        ImU32 bg_col = (popup_open || hovered) ? ImColor(accent_colour[0] - 0.05f, accent_colour[1] - 0.05f, accent_colour[2] - 0.05f, content_animation) : ImColor(accent_colour[0], accent_colour[1], accent_colour[2], content_animation);
        ImU32 text_col = GetColorU32(ImGuiCol_Text);
    ...
    if (label_size.x > 0)
        RenderText(ImVec2(bb.Min.x, bb.Min.y - style.FramePadding.y - 15), label);
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    if (grab_bb.Max.x > grab_bb.Min.x) {
        ImColor col = (g.ActiveId == id ? ImColor(accent_colour[0] - 0.05f, accent_colour[1] - 0.05f, accent_colour[2] - 0.05f, content_animation) : ImColor(accent_colour[0], accent_colour[1], accent_colour[2], content_animation));
        window->DrawList->AddRectFilled(frame_bb.Min + ImVec2(0, 1), grab_bb.Max + ImVec2(2, 1), col, 2.0f);
    }
...
bool ImGui::Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
    ...
    if (hovered || selected)
    {
        const ImU32 col = (held && hovered) ? ImColor(accent_colour[0] - 0.05f, accent_colour[1] - 0.05f, accent_colour[2] - 0.05f) : ImColor(accent_colour[0], accent_colour[1], accent_colour[2]);
